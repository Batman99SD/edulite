          ...
          <div className="flex flex-col md:flex-row items-center gap-8">
            <div className="flex-1">
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                At Edulite, our mission is to make quality education accessible
                to everyone, everywhere. We aim to create a platform that
                empowers learners by providing expertly designed courses,
                tailored resources, and an engaging learning experience.
              </p>
            </div>
            <div className="flex-1">
              <img
          ...
          <div className="flex flex-col md:flex-row-reverse items-center gap-8">
            <div className="flex-1">
              <p className="text-lg text-gray-600 leading-relaxed">
                ...
                thousands of learners, our journey has been fueled by a passion
                for education and a commitment to excellence.
              </p>
            </div>
            <div className="flex-1">
              <img
